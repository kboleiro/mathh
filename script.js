...
const text_qtde = document.getElementById("text_qtde")
...
class Bola {
    ...
    desenhar=()=> {
        ...
        div.setAttribute("style",`left: ${this.px}px; top: ${this.py}px; width:${this.tam}px; height: ${this.tam}px; background-color: rgb(${this.r}px, ${this.g}px, ${this.b}px) `)
...
btn_add.addEventListener("click", (evt) => {
    const qtde = parseInt(text_qtde.value);
